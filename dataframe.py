...
for day in range(days):
    ...
    for hour in range(24):
            ...
            if day < 10:
                date="2021-02-0"+str(day)
            else:    
                date="2021-02-"+str(day)
            ...
            url = 'https://crix-api-endpoint.upbit.com/v1/crix/candles/minutes/1?code=CRIX.UPBIT.KRW-BTC&count=60&to='+date+"%20"+time
